...
describe('Sitemapper Increased Coverage Tests', function () {
    ...
    describe('Parse method edge cases', function () {
        it('should handle non-200 status codes', function () {
    ...
    describe('Crawl method edge cases', function () {
        it('should log debug message when finding sitemapindex', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                debugSitemapper.parse = () => __awaiter(this, void 0, void 0, function* () {
                    parseCallCount++;
                    if (parseCallCount === 1) {
                        return {
                            error: null,
                ...
                try {
                    yield debugSitemapper.crawl('https://example.com/sitemapindex.xml');
        ...
        it('should handle retry when no urlset or sitemapindex found', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let parseCallCount = 0;
                retrySitemapper.parse = () => __awaiter(this, void 0, void 0, function* () {
                    parseCallCount++;
                    return {
                        error: null,
                        data: {
                ...
                try {
                    const result = yield retrySitemapper.crawl('https://example.com/empty-sitemap.xml');
        ...
        it('should handle exceptions in crawl with debug enabled', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const debugSitemapper = new Sitemapper({
                    debug: true,
                });
                ...
                try {
                    ...
                    yield debugSitemapper.crawl('https://example.com/error-sitemap.xml');
        ...
        it('should exclude sitemaps in sitemapindex based on exclusion patterns', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let parsedUrls = [];
                excludeMapper.parse = (url) => __awaiter(this, void 0, void 0, function* () {
                    parsedUrls.push(url);
                ...
                const result = yield excludeMapper.crawl('https://example.com/sitemapindex.xml');
    ...
    describe('getSites method coverage', function () {
        it('should handle errors in getSites callback', function () {
            return __awaiter(this, void 0, void 0, function* () {
                // Mock fetch to throw an error
                const originalFetch = sitemapper.fetch;
                sitemapper.fetch = () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('Response parsing with non-200 status', function () {
        it('should handle response with statusCode !== 200', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const result = yield testMapper.parse('https://example.com/503.xml');
    ...
    describe('Fields option with sitemap field', function () {
        it('should include sitemap field when specified', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                fieldsMapper.parse = () => __awaiter(this, void 0, void 0, function* () {
                    return {
                        error: null,
                        data: {
                            urlset: {
                ...
                const result = yield fieldsMapper.crawl('https://example.com/source-sitemap.xml');
                result.sites.length.should.equal(2);
